import { CompleteUser, relatedUserSchema } from "@/prisma/zod"
import * as z from "zod"

export const customPersonalInformationSchema = z.object({
  id: z.string(),
...
export interface CompletePersonalInformation extends z.infer<typeof customPersonalInformationSchema> {
  user: CompleteUser
}
 ...
 */
export const relatedPersonalInformationSchema: z.ZodSchema<CompletePersonalInformation> = z.lazy(() => customPersonalInformationSchema.extend({
